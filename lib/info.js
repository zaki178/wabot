exports.info = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, twitter, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🐼 ${BotName} 🐼
...
INFO BOT! :
🔱 *AUTHOR*: MEOW
🔱 *GITHUB*: https://github.com/meowcraftg/wabot
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
🔱 *TWITTER* : ${twitter}

🔱 *SCRIPT ORIGINAL BY*: https://github.com/benisadewa/kntnbotwa
