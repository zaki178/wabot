exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, twitter, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🤖 *${BotName}* 🤖
...
📺 *IKLAN* : *YOUTUBE MEOW CRAFT*

♻️SELALU GUNAKAN MASKER SAAT KELUAR!♻️
🙏SEMOGA SEHAT SELALU!🙏
`
}
