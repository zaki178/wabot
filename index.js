...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] SCAN KODE QR NYA DI WA COK!`);
});
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot edited by ig:meowcraft_')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot edited by ig:meowcraft_`)
})
...
====================================
   ...
   {
    var items = ["cowo ganteng", "cogan", "russian boy", "chinese boy", "japan boy", "cowok indo ganteng", "cowok korea"];
